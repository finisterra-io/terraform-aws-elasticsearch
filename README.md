...
| <a name="input_encrypt_at_rest"></a> [encrypt\_at\_rest](#input\_encrypt\_at\_rest) | Configuration block containing encryption at rest options | <pre>object({<br>    enabled       = bool<br>    kms_key_id    = optional(string)<br>    kms_key_alias = optional(string)<br>  })</pre> | `null` | no |
